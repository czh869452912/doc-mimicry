...
**Spec coverage:**
- TanStack Router typed search params: Tasks 1–4 ✓
- TanStack Query data hooks: Task 3 ✓
- useWorkspaces dissolved: Tasks 4, 6 ✓
- SSE invalidation (path-based): Task 5 ✓
- Exponential backoff reconnect + catchup: Task 5 ✓
- Remove interval polling: Task 6 ✓
- Remove draftReloadToken: Task 6 ✓
- Remove clear-before-load in useTimeline: Task 5 ✓
- created_at in TimelineEvent + real timestamps: Task 2 ✓
- Test harness migration: Task 7 ✓
